...
export default function StatusPage() {
  /* Named `refreshMs`, not `interval`. As `interval` it shadowed the global
     `setInterval` for this entire module — any timer added to this file would
          ...
          >
            ...
            {REFRESH_OPTIONS.map((option) => (
              <button
                ...
                /* The same selected treatment as the Cabinet's tab strip.
                   Two segmented controls in one app that mark the current
